...
Class TP_Latest_Posts_Footer_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('tp-latest-posts-footer', 'Dustrilox Footer Posts', array(
			'description'	=> 'Latest Post Widget by Dustrilox'
		));
	}
	...
	public function widget($args, $instance){
     	...
     	<?php endif; ?>
	     	...
	     	<div class="tp-footer-news footer__post">
				...
				<div class="footer__post-item pb-20">
	                ...
	                <div class="footer__post-item-content">
	                    ...
	                    <h5><a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 7, ''); ?></a></h5>
	                </div>
	            </div>
