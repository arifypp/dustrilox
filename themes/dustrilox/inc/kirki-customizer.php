...
function _header_top_fields( $fields ) {
    ...
    $fields[] = [
        ...
        'label'    => esc_html__( 'Get A Quote', 'dustrilox' ),
        'section'  => 'header_top_setting',
        'default'  => '0',
        'priority' => 10,
    ];
    ...
    $fields[] = [
        'type'     => 'text',
        'settings' => 'dustrilox_mail',
        'label'    => esc_html__( 'Email Address', 'dustrilox' ),
        'section'  => 'header_top_setting',
