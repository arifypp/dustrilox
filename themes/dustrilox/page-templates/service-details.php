               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="about__image about__image-2">
                     ...
                     <div class="about__image-small about__image-small-2">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/about/about-img-8.jpg" alt="">
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
                  <div class="about__right-2">
                     <div class="about__info pb-20">
                        <div class="section-2__wrapper mb-30">
                           <h5 class="section__title-sm">An effective business strategy for companies</h5>
                        </div>
                        <p>Can we help our clients succeed by creating brand identity, digital experiences, and print materials. Financial consulting slogans and Financial consu lting be used to  lients succeed by creatin communic.</p>
                     </div>
               ...
               <div class="swiper-wrapper">
                     ...
                     <div class="testimonial__item-box text-center">
                        ...
                        <div class="author__info">
                           <div class="author__image">
                              <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/author/author-7.jpg" alt="author"></a>
                           </div>
                  ...
                  <div class="swiper-slide testimonial__slider-3-item">
                     <div class="testimonial__item-box text-center">
                        ...
                        <div class="author__info">
                           <div class="author__image">
                              <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/author/author-6.jpg" alt="author"></a>
                           </div>
                           <div class="author__content">
                              <h5>Iqbal Hossain</h5>
                              <span>Head of Idea</span>
                  ...
                  <div class="swiper-slide testimonial__slider-3-item">
                     <div class="testimonial__item-box text-center">
                        ...
                        <div class="author__info">
                           <div class="author__image">
                              <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/author/author-5.jpg" alt="author"></a>
                           </div>
                           <div class="author__content">
                              <h5>Nico Robin</h5>
                              <span>Head of Idea</span>
               ...
               <div class="row align-items-center">
                  <div class="col-xl-5 col-lg-5 col-md-5">
                     <div class="nevigation__info mb-20 pl-30">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/nav/nav-img-1.jpg" alt="nav-img" class="img-fluid">
                        <div class="nevigation__content">
                           <h6 class="nevigation__title"><a href="services-details.html">Manufacturing</a></h6>
                           <p><a href="services-details.html">Prev  Service</a></p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-2 col-lg-2 col-md-2">
                     <div class="nevigation__icon text-center mb-20"><a href="services-details.html"><i class="fas fa-th"></i></a></div>
                  </div>
                  <div class="col-xl-5 col-lg-5 col-md-5">
                     <div class="nevigation__info nevigation__info-2 mb-20 pr-30">
                        <div class="nevigation__content">
                           <h6 class="nevigation__title"><a href="services-details.html">Construction</a></h6>
                           <p><a href="services-details.html">Next  Service</a></p>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/nav/nav-img-2.jpg" alt="nav-img" class="img-fluid">
                     </div>
                  </div>
               </div>
            </div>
