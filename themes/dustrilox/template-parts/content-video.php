...
<article id="post-<?php the_ID();?>" <?php post_class( 'tp-blog format-video mb-50' );?>>
    ...
    <div class="tp-blog__thumb m-img mb-35">
       ...
       <div class="vide-button vide-button-3">
          <a href="<?php print esc_url( $dustrilox_video_url );?>" class="popup-video"><i class="fa-solid fa-play"></i></a>
       </div>
       <?php endif; ?>
    </div>
    <?php endif; ?>
