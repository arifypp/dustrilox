      ...
      <div class="sidebar__content">
         ...
         <div class="sidebar__search mb-25">
            <form method="get" action="<?php print esc_url( home_url( '/' ) ); ?>">
               <input type="text" name="s" value="<?php print esc_attr( get_search_query() ); ?>" placeholder="<?php print esc_html__('What are you searching for?', 'dustrilox'); ?>">
         ...
         <div class="sidebar__map d-none d-lg-block mb-15">
            <iframe src="<?php echo esc_url($dustrilox_extra_map); ?>"></iframe>
         </div>
         <?php endif; ?>
