<?php 
	...
	*/
    ...
    $dustrilox_mail_id = get_theme_mod( 'dustrilox_mail_id', __( 'info@dutrilox.com', 'dustrilox' ) );
    ...
    $dustrilox_menu_col = $dustrilox_header_right ? 'col-xl-7 col-lg-6 col-md-6 col-6' : 'col-xl-10 col-lg-6 col-md-6 col-6 text-end';
               ...
               <div class="header-info f-right">
                  ...
                  <?php if( !empty($dustrilox_mail_id) ) : ?>
                     <div class="info-item">
                        ...
                        <h5><a href="mailto:<?php echo esc_attr($dustrilox_mail_id); ?>"><?php echo esc_html($dustrilox_mail_id); ?></a></h5>
                     </div>
                  <?php endif; ?>
               </div>
            </div>
