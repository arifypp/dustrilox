<?php 
	...
	*/
    ...
    $dustrilox_topmenu = get_theme_mod( 'dustrilox_topmenu', __('Set top menu', 'dustrilox') );
    $dustrilox_phone_num = get_theme_mod( 'dustrilox_phone_num', __( '786 686 350 36', 'dustrilox' ) );
         ...
         <div class="row align-items-center">
            <div class="col-xl-7 col-lg-7 col-md-7">
               <div class="header__top-info">
                  ...
                  <p><a href="<?php echo esc_attr($dustrilox_delivery_url); ?>"><?php echo esc_html($dustrilox_delivery); ?></a></p>
                  <?php endif; ?>
            ...
            <div class="col-xl-5 col-lg-5 col-md-5">
               <div class="header__top-right">
                  <?php if( !empty($dustrilox_topmenu) ) : ?>
                  <div class="header__sm-links">
                     <?php echo dustrilox_kses($dustrilox_topmenu); ?>
                  </div>
                  <?php endif; ?>
                  <div class="header__lang">
                     ...
                     </select><div class="nice-select" tabindex="0"><span class="current">Bangla</span><ul class="list"><li data-value="English" class="option">English</li><li data-value="Bangla" class="option selected focus">Bangla</li><li data-value="French" class="option">French</li></ul></div>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="header__smcontact">
                  ...
                  <div class="header__smcontact-list">
                     ...
                     <div class="sm-clist__text">
                        <h4><a href="<?php echo esc_attr($dustrilox_address_url); ?>" target="_blank"><?php echo esc_html($dustrilox_address); ?></a></h4>
                  ...
                  <div class="header__smcontact-list header__smcontact-list-df">
                     <div class="sm-clist__text sm-clist__text-2">
                        ...
                        <h4><a href="<?php echo esc_attr($dustrilox_button_link); ?>"><?php echo esc_html($dustrilox_button_text); ?></a></h4>
                     </div>
                     <div class="sm-clist__icon sm-clist__icon-2">
                       <a href="<?php echo esc_attr($dustrilox_button_link); ?>"> <i class="fal fa-long-arrow-right"></i></a>
                     </div>
                  </div>
                  <?php endif; ?>
               </div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-6">
               <div class="header__sm-action">
                  ...
                  <div class="header__sm-action-item d-none">
                     <a href="about.html"><i class="fa-light fa-user"></i></a>
                  </div>
               </div>
            </div>
         </div>
