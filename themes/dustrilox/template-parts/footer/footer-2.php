...
// bg image
$footer_main_bg_img = !empty( $dustrilox_footer_bg_url_from_page['url'] ) ? $dustrilox_footer_bg_url_from_page['url'] : $footer_bg_img;
...
<!-- footer area start --> 
<footer>
     <div class="footer__area-2" data-bg-color="<?php print esc_attr( $bg_color );?>" data-background="<?php echo esc_url( $footer_main_bg_img );?>">
